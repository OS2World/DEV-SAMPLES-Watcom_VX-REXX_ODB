...
#define DLLNAME "BOUNDPB"

#define MINIMUM_VXREXX_LEVEL 210
#define LEVEL_ERRORMSG "This object library requires VX-REXX version 2.10 or higher."
#define LEVEL_TITLE "BOUNDPB Object Library"

#define VERSION 100
#define VERSION_STRING "1.00"

#define VersionEntry _BOUNDPB_VERSION_INFO_

/* Icon definitions */
PSZ VRBoundPushButtonPicturePath = "#100:" DLLNAME ;
/* :sominit:icons:101: */
...
void _System SOMInitModule( integer4 majorVersion, integer4 minorVersion )
  {
    ...
    VRBoundPushButtonNewClass( majorVersion, minorVersion );
    /* :sominit:init: */
  }
